...
#define	USER_CLASSPATH ".;./prev.jar;./lib/jaybird-full-2.0.1.jar;;./lib/jaybird-full-2.0.1.jar;./lib/jcalendar.jar;./lib/jfreechart-1.0.1.jar;./lib/jcommon-1.0.2.jar;./lib/simpleftp.jar;"//;PC_getion_inventario.jar" /*	where Prog.class is	*/
